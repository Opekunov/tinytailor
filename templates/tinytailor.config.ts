import type { TinyTailorConfig } from 'tinytailor';

const config: TinyTailorConfig = {
  // Project paths
...
/*
🎯 TinyTailor Configuration Guide (TypeScript)

This is the TypeScript version of the configuration file.
Use this format for maximum type safety and IntelliSense support
